...
<section class="py-3 py-md-5 py-xl-8">
  ...
  <div class="container">
    <div class="row gy-4 gy-md-5 gy-lg-0 align-items-md-center">
      ...
      <div class="col-12 col-lg-6">
        <div class="row justify-content-xl-center ContactMeImage">
        <div className='CoverMeBack'>
          <div class="col-12 col-xl-11">
            <div class="mb-4 mb-md-5">
              ...
              <div>
                ...
                <address class="m-0 text-light">Ceremonial Street, Sakumono Estate, Tema, Ghana</address>
              </div>
            </div>
              ...
              <div class="col-12 col-sm-6">
                <div class="mb-4 mb-sm-0">
                  ...
                  <div>
                    ...
                    <hr class="w-75 mb-3 border-dark-subtle"/>
                    <p class="mb-0">
                      <a class="link-light text-decoration-none" href="mailto:demo@yourdomain.com" style={{color: 'white'}}>spa-magic@gmail.com</a>
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <div>
                ...
                <div class="d-flex mb-1">
                  ...
                  <p class=" mb-0" style={{color: 'white'}}>9am - 5pm</p>
                </div>
                <div class="d-flex">
